...
<figure class="youtube-video">
    ...
    public static function createProjects() {
        $p = new Project('University', 'Bachelor & Masters');
        $p->summary = 'Projects developed as study or assignments during my bachelor course at UFSC/FASP or my masters at UTS.';
        $r[$p->key] = $p;

        $p = new Project('GNLC', 'Slot Car Lap Counter');
        $p->summary = 'Open-source Hardware and Software to manage Slot Car Races. Includes pictures and videos on how to DIY.';
        $r[$p->key] = $p;
